 ...
 *   value         - reflects validity: "true" valid, "false" invalid, absent = not validated
 *
 * Events:
 *   submit        - { valid, errors }; native submit is prevented
 *   change        - { value: boolean | null } when aggregate validity changes
 *
