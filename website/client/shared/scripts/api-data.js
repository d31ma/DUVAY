  ...
  '/docs/buttons': [
    {
      ...
      attributes: [
        ...
        ['aria-pressed', 'true | false | mixed', '—', 'Toggle state, forwarded to the rendered button. Omitted from the link form, where it is not valid.'],
        ['aria-expanded / aria-controls / aria-haspopup / aria-current / aria-labelledby / aria-describedby', 'string', '—', 'ARIA authored on the host is forwarded to the rendered control, which is what the accessibility tree exposes.'],
      ],
      events: [
  ...
  '/docs/cards': [
    {
      tag: 'w-card',
      attributes: [
        ['title / subtitle / text', 'string', '—', 'Generates the card item and body text regions.'],
        ['image', 'URL', '—', 'Displays a decorative image above the card content.'],
        ['prepend-avatar / append-avatar', 'URL', '—', 'Displays avatar media around the generated title region.'],
        ['prepend-icon / append-icon', 'string', '—', 'Displays icon text or glyphs around the generated title region.'],
        ['href', 'string', '—', 'Renders the card as a native link.'],
        ['target / rel', 'string', '—', 'Forwards native link behavior when href is set.'],
        ['link', 'boolean', 'false', 'Gives a non-anchor card button semantics and Enter/Space activation.'],
        ['hover', 'boolean', 'false', 'Adds visual hover elevation without making the card keyboard-interactive.'],
        ['disabled', 'boolean', 'false', 'Removes link and click affordances.'],
        ['variant', 'elevated | flat | tonal | outlined | text | plain', 'elevated', 'Sets the card surface treatment.'],
        ['color', 'semantic color name', '—', 'Sets the card color role.'],
        ['loading', 'boolean | semantic color name', 'false', 'Shows a top loading bar, optionally in the named color.'],
        ['ripple', 'boolean', 'false', 'Adds press feedback to an actionable card.'],
        ['rounded / border / tile', 'boolean | radius name', 'false', 'Controls card corners and border treatment.'],
        ['density / elevation', 'string | 0-6', '—', 'Adjusts card spacing and resting shadow.'],
        ['header / footer', 'string', '—', 'Supports the legacy generated header and footer regions.'],
      ],
      slots: [
        ['default', 'Card body content.'],
        ['image', 'Custom top media.'],
        ['item', 'Replaces the generated title item.'],
        ['prepend / title / subtitle / append', 'Custom content for the generated title item.'],
        ['text', 'Custom body text region.'],
        ['actions', 'Action buttons or controls.'],
        ['loader', 'Custom loading indicator.'],
        ['header', 'Legacy custom header content.'],
  ...
  '/docs/progress-linear': [
    {
      ...
      attributes: [
        ...
        ['aria-label / aria-labelledby / aria-describedby', 'string', '—', 'Names the rendered element that carries role="progressbar"; without one the progressbar is unnamed to assistive technology.'],
      ],
