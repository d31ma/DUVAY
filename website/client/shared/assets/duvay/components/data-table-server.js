 ...
 *
 * See <w-data-table> for the shared attributes and events — every presentation,
 * sorting, selection, expansion, grouping, and footer attribute documented there
 * (must-sort, disable-sort, gridlines, mobile, group-by, page-text, …) is
 * inherited. Only the client-side filtering attributes (search, no-filter,
 * filter-keys, filter-mode) are inert here, because the server owns filtering.
 */
