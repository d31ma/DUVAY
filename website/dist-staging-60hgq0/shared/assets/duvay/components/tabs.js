 ...
 *
 * Events:
 *   w-change - fires when the active tab changes (detail: { value })
 *
 * Usage:
...
class WTabs extends WElement {
  ...
  attributeChangedCallback(name, oldVal, newVal) {
    ...
    // animate. Reflect value/model-value by syncing active state in place.
  ...
  _activateTab(tabEl) {
    ...
    this._emit('w-change', { value: newValue });
  }
