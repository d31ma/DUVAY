...
export function wModelValue(host, fallback = '') {
  return host.getAttribute('model-value') ?? host.getAttribute('value') ?? fallback;
}
...
export function wPrimitiveModelValue(host, fallback = '') {
  return host.getAttribute('model-value') ?? host.getAttribute('value') ?? fallback;
}
