...
class WElement extends HTMLElement {
  ...
  _bool(name) {
    ...
    if (name === 'open' || name === 'active' || name === 'checked' || name === 'selected') {
      const model = this.getAttribute('model-value');
      return model != null && model !== 'false' && model !== '0';
    }
    return false;
  }
  ...
  _emit(name, detail) {
    ...
    if (detail && Object.prototype.hasOwnProperty.call(detail, 'value') && name !== 'update:model-value') {
