  ...
  _events() {
    ...
    if (this.__wDrawerTarget !== drawer) {
      if (this.__wDrawerTarget && this.__wDrawerSync) {
        this.__wDrawerTarget.removeEventListener('w-open', this.__wDrawerSync);
        this.__wDrawerTarget.removeEventListener('w-close', this.__wDrawerSync);
      }
      this.__wDrawerTarget = drawer;
      this.__wDrawerSync = () => this._syncExpanded();
      if (drawer) {
        drawer.addEventListener('w-open', this.__wDrawerSync);
        drawer.addEventListener('w-close', this.__wDrawerSync);
      }
    }
  }
